...
<li>Edit <code>data/config.json</code>
  <ul>
    <li>As it is a JSON file, be sure to format accordingly. I <i>strongly</i> recommend you paste it into a JSON checker after you are done, such as this: https://jsonlint.com/</li>
    <li>Settings
      <ul>
      <li>real_screen</li>
